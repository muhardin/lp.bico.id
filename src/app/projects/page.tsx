          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7">
            ...
            <a href="/projects/2">
              ...
              >
                <Image
                  className="w-full h-[140px] object-cover rounded-t-md pointer-events-none"
                  src="https://storage.googleapis.com/icx-bucket-production/ASMA-cover-image.png"
                  alt="company-list"
                  width={500}
                  height={140}
                />
                <div className="px-4 pt-8 pb-10 relative">
                  <Image
                    className="w-[50px] h-[50px] object-cover rounded-md absolute top-[-30px] pointer-events-none"
                    src="https://storage.googleapis.com/icx-bucket-production/3xASMA-company-logo.png"
                    alt="company-list"
                    width={50}
                    height={50}
                  />
                  <div className="cursor-pointer">
                    <p className="font-semibold text-md line-clamp-1">
                      Kapal SM Alam Bahari 6
                    </p>
                    <p className="text-xs line-clamp-1">
                      PT. Anargya Sinar Maritim
                    </p>
                    <p className="font-light text-xs text-brand-500 mt-3">
                      Target Pendanaan
                    </p>
